...
const Adminhome = () => {
  ...
  return (
   ...
   <div className='body'>
    ...
    <Link className='admin-home-link' to={`/staffreg`} >Staff Registration</Link>
    ...
    <Link className='admin-home-link'  to={`/staffview`}>  View Staff Details</Link>
...
<div>
    ...
    <Link className='admin-home-link'  to={`/adminstudentview`}>  View Student Details</Link>
